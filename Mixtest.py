...
parser.add_argument('--labeled-id-path', type=str, default="../../../../../../home/lin/remote_sense/EH/VOCdevkit/VOC/Mix_Train/train.txt")
parser.add_argument('--val-id-path', type=str, default="../../../../../../home/lin/remote_sense/EH/VOCdevkit/VOC/Mix_Train/val.txt")


# parser.add_argument('--unlabeled-id-path', type=str, default="splits/pascal/un_1_1/unlabeled.txt")
parser.add_argument('--save-path', type=str, default="myEH/d_hrnet/mix")
...
def main():
    ...
    mIoU, iou_class = evaluate(model, valloader, 'center_crop', cfg)
