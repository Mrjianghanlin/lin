...
parser.add_argument('--labeled-id-path', type=str, default="../../../../../home/lin/remote_sense/EH/VOCdevkit/VOC/down512train/train.txt")
parser.add_argument('--val-id-path', type=str, default="../../../../../home/lin/remote_sense/EH/VOCdevkit/VOC/down512train/val.txt")


# parser.add_argument('--unlabeled-id-path', type=str, default="splits/pascal/un_1_1/unlabeled.txt")
parser.add_argument('--save-path', type=str, default="myEH/d_hrnet/single512down")
