...
parser.add_argument('--val-id-path', type=str, default="../../../../../../home/lin/remote_sense/EH/VOCdevkit/VOC/Mix_Train_updata/val.txt")

# parser.add_argument('--unlabeled-id-path', type=str, default="splits/pascal/un_1_1/unlabeled.txt")
parser.add_argument('--save-path', type=str, default="myEH/Mix_model_update/deep_sing_EH_512")
