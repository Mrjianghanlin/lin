...
parser.add_argument('--labeled-id-path', type=str, default="../../../../../../home/lin/remote_sense/EH/VOCdevkit/VOC/Mix_Train_updata/train.txt")
# parser.add_argument('--labeled-id-path', type=str, default="../../../../../../home/lin/remote_sense/EH/VOCdevkit/VOC/active_quan/train1.txt")
parser.add_argument('--val-id-path', type=str, default="../../../../../../home/lin/remote_sense/EH/VOCdevkit/VOC/VOC16_23Train/val.txt")
parser.add_argument('--unlabeled-id-path', type=str, default="../../../../../../home/lin/remote_sense/EH/VOCdevkit/VOC/VOC16_23Train/train.txt")
parser.add_argument('--save-path', type=str, default="myEH/Mix_model_update_semi/mix_semi")
parser.add_argument('--local_rank', default=0, type=int)
parser.add_argument('--port', default=None, type=int)
parser.add_argument('--freeze-epochs', type=int, default=0)

# torch.cuda.set_device(1)
# os.environ['CUDA_LAUNCH_BLOCKING'] = '1'            # 精确内存错误定位
...
def main():
    ...
    valloader = DataLoader(valset, batch_size=1, pin_memory=True, num_workers=1,
                           drop_last=False)
    total_iters = len(trainloader_l) * cfg['epochs']  # 1875 * epochs
    ...
    for epoch in range(epoch + 1, cfg['epochs']):
        ...
        # 修改数据加载组合方式
        # loader = zip(trainloader_l, cycle(trainloader_u), cycle(trainloader_u))
