...
parser.add_argument('--labeled-id-path', type=str, default="../../../../../../home/lin/remote_sense/EH/VOCdevkit/VOC/Mix_Train333/train.txt")
parser.add_argument('--val-id-path', type=str, default="../../../../../../home/lin/remote_sense/EH/VOCdevkit/VOC/active_quan/val.txt")


# parser.add_argument('--unlabeled-id-path', type=str, default="splits/pascal/un_1_1/unlabeled.txt")
# parser.add_argument('--save-path', type=str, default="myEH/d_hrnet/random_16_23mix20")
parser.add_argument('--save-path', type=str, default="myEH/d_hrnet/active_16_23mix20")
