...
from models.nets import (get_lr_scheduler, set_optimizer_lr,
                         weights_init)
from models.new_network.modeling import deeplabv3plus_resnet101
from models.new_network.utils import LossHistory, EvalCallback
from models.new_network.utils import DeeplabDataset, deeplab_dataset_collate
from models.new_network.utils import download_weights, show_config
from models.new_network.utils import fit_one_epoch
...
model = deeplabv3plus_resnet101(num_classes=num_classes, output_stride=downsample_factor, pretrained_backbone=pretrained)
