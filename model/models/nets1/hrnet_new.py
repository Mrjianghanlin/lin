...
def HRNet_Backbone_New(backbone="hrnetv2_w18", pretrained=False):
    model_urls = {
        "hrnetv2_w18": "https://github.com/bubbliiiing/hrnet-pytorch/releases/download/v1.0/hrnetv2_w18_imagenet_pretrained.pth",
        "hrnet_w32": "https://github.com/bubbliiiing/hrnet-pytorch/releases/download/v1.0/hrnetv2_w32_imagenet_pretrained.pth",
    ...
    if backbone == "hrnet_w18":
        backbone_model = HighResolutionNet(base_channel=18)
    elif backbone == "hrnet_w32":
        backbone_model = HighResolutionNet(base_channel=32)
    elif backbone == "hrnet_w48":
        backbone_model = HighResolutionNet(base_channel=48)
    else:
