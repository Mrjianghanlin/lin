...
def swin_base_patch4_window12_384(num_classes: int = 1000, **kwargs):
    ...
    pretrained = True
    if pretrained:
        # model.load_state_dict(torch.load("./model_data/swin_base_patch4_window12_384.pth"),["model"])
        weights_dict = torch.load("./model_data/swin_base_patch4_window12_384.pth", map_location="cpu")["model"]
...
def swin_large_patch4_window12_384_in22k(num_classes: int = 21841,**kwargs):
    ...
    pretrained = True
    if pretrained:
        model.load_state_dict(load_url('https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_large_patch4_window12_384_22k.pth'), strict=False)
