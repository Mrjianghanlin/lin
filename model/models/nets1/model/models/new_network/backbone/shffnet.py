...
def shufflenet(pretrained=False, progress=True, **kwargs):
    """
    ...
    """
    model = shufflenet_v2_x2_0(**kwargs)
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls['shufflenet_v2_x2_0'],
                                              progress=progress)
