...
from model.models.nets1.resnext import resnext101_32x8d_backbone
...
from model.models.model.modules.backbones.resnet_backbone import ResNetBackbone
...
class DeepLabV3Plus(nn.Module):
    def __init__(self, cfg):
        ...
        if cfg['backbone'] in ["resnet50", "resnet101"]:
        ...
        elif cfg['backbone'] == "resnext101":
            # 使用自定义的封装，确保有 base_forward
            self.backbone = resnext101_32x8d_backbone(pretrained=cfg['pretrained'])
            self.low_channels, self.high_channels = 256, 2048
            ...
            self.backbone = HRNet_Backbone(backbone="hrnetv2_w48", pretrained=cfg['pretrained'])
